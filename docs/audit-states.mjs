...
writeFileSync(`${OUT}/audit-states.json`, JSON.stringify(allResults, null, 2));
...
writeFileSync(`${OUT}/audit-states.html`, `<!doctype html>
<html lang="en">
<meta charset="utf-8">
...
console.log('done: docs/audit-states.html, docs/audit-states.json');
